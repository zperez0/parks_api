...
describe "post a park route", type: :request do
  before do
    post "/api/v1/parks", params: { name: "test name", longitude: 123, latitude: 456, statecode: "FL", animal: "test_animal", kind: "state", description: "test_description" }
  end
...
describe "expections work as expected", type: :request do
  it "throws error if name field is empty" do
    post "/api/v1/parks", params: { name: "", longitude: 123, latitude: 456, statecode: "FL", animal: "test_animal", kind: "state", description: "test_description" }
  ...
  it "throws error if longitude field is empty" do
    post "/api/v1/parks", params: { name: "test_name", latitude: 456, statecode: "FL", animal: "test_animal", kind: "state", description: "test_description" }
    expect(response).to have_http_status(422)
  ...
  it "throws error if latitude field is empty" do
    post "/api/v1/parks", params: { name: "test_name", longitude: 123, statecode: "FL", animal: "test_animal", kind: "state", description: "test_description" }
    expect(response).to have_http_status(422)
  ...
  it "throws error if statecode field is empty" do
    post "/api/v1/parks", params: { name: "test_name", longitude: 123, latitude: 456, statecode: "", animal: "test_animal", kind: "state", description: "test_description" }
    expect(response).to have_http_status(422)
  ...
  it "throws error if animal field is empty" do
    post "/api/v1/parks", params: { name: "test_name", longitude: 123, latitude: 456, statecode: "FL", animal: "", kind: "state", description: "test_description" }
    expect(response).to have_http_status(422)
  ...
  it "throws error if kind field is empty" do
    post "/api/v1/parks", params: { name: "test_name", longitude: 123, latitude: 456, statecode: "FL", animal: "test_animal", kind: "", description: "test_description" }
    expect(response).to have_http_status(422)
  ...
  it "throws error if description field is empty" do
    post "/api/v1/parks", params: { name: "test_name", longitude: 123, latitude: 456, statecode: "FL", animal: "test_animal", kind: "state", description: "" }
    expect(response).to have_http_status(422)
